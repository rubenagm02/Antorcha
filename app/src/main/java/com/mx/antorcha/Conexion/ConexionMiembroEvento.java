...
import static com.mx.antorcha.Conexion.InfoConexion.URL_INSERTAR_MIEMBRO_EVENTO;
import static com.mx.antorcha.Modelos.Pendiente.SEP;

/**
 * Created by root on 29/03/16.
 */
public class ConexionMiembroEvento {
    ...
    public ConexionMiembroEvento(Context context, int idMiembro, int idEvento, int tipo) {
    ...
    public void insertarEvento () {
        StringRequest postRequest = new StringRequest(Request.Method.POST, URL_INSERTAR_MIEMBRO_EVENTO,
                        ...
                        try {
                            ...
                            if (jsonObject.getBoolean("Respuesta")) {
                                ...
                                if (tipo == 0) {
                                    ...
                                    Pendiente pendiente = new Pendiente(0, Pendiente.MIEMBRO_EVENTO, datos);
