...
public class InfoConexion {
    ...
    final static public String URL_INFORMACION_ESPACIO = "api.antorcha.mx/V0.1/espaciosDeportivos/";
    final static public String URL_BUSCAR_EVENTO = "";
    final static public String URL_INFORMACION_EVENTO = " ";
    final static public String URL_MEDALLA = "api.antorcha.mx/V0.1/medallas";
}
