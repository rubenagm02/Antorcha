...
public class InfoConexion {
    ...
    final static public String URL_BUSCAR_EVENTO = "http://api.antorcha.mx/V0.1/eventosDeportivos/";
    ...
    final static public String URL_RESENIA = "http://api.antorcha.mx/V0.1/resenias";
    ...
    final static public String URL_OBTENER_ESPECIALIDADES = "http://api.antorcha.mx/V0.1/xEspecialidad/";
    final static public String URL_VALORACION = "http://api.antorcha.mx/V0.1/valoraciones";
    final static public String URL_INSERTAR_DISCIPLINA = "http://api.antorcha.mx/V0.1/miembroDisciplina";
    final static public String URL_INSERTAR_DEPORTE = "http://api.antorcha.mx/V0.1/miembroDeporte";
    final static public String URL_INSERTAR_MIEMBRO_ESPACIO = "http://api.antorcha.mx/V0.1/miembro/espacioDeportivo";
    final static public String URL_INSERTAR_MIEMBRO_EVENTO = "http://api.antorcha.mx/V0.1/miembro/eventoDeportivo";
    final static public String URL_BORRAR_MIEMBRO_ESPACIO = "http://api.antorcha.mx/V0.1/miembro/espacioDeportivo";
    ...
    final static public String URL_SUBIR_EVENTO = "http://admin.antorcha.mx/V0.1/eventosDeportivos/create";
